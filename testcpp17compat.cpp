...
int main() { 
  ...
  std::cout << a::b::c::str << ' '; // prints the str variable from the a::b::c namespace
  std::cout << iNumbers << ' ' << iSum << std::endl; // prints iNumbers, a space, iSum and a newline (std::endl flushes stdout unlike '\n' which may or may not be desirable)
